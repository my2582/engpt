...
col2.image(image, caption='대화 예시', use_column_width='auto')

method = 'openai'
openai.api_key = st.secrets['open_ai_key']

st.subheader(':yellow[시작]')
...
Provide answers in the form of hierarchical bullet points. In the last part of your answer, do translate of each of your answer into Korean.
